...
Status: canonical design decision after Stage 13; Stage17 AI Yandex Ops Agent Foundation, Stage18 deterministic recovery execution, Stage19 no-secret operator fallback and Stage20 contract-drift diagnosis accepted fail-closed on 2026-09-22.
