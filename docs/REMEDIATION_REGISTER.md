...
> **Native/Windows gate checkpoint 2026-09-14:** current source `c47b83b179b9a94781d55029b4b399c44f9a075b` was not rewritten; the ready patch was already applied. Actual Windows gate: 489/489 tests and 107/107 checks PASS, PowerShell 7.6.5. Native PostgreSQL 17 concurrency is `NOT_RUN` because `tools/contract-recovery/native-concurrency.py`, `initdb`, `pg_ctl` and `psql` are unavailable. This does not close the native concurrency blocker. See `docs/NATIVE_WINDOWS_GATE_20260914.md`.
