...
Текущий шаг — «Диагностика без импорта» в 0.2.2: только сводные количества
после подтверждённого COOKIE_SET_TOO_LARGE, без имён/values/CLI/БД.
Лимит импорта и validator не менялись; количество пригодных записей ещё неизвестно.
...
Ожидается результат диагностического подсчёта 0.2.2 в настоящем Chrome.
