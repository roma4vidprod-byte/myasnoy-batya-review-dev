...
export function classifyContractDrift(input){
  ...
  }else if(e.page.result==='PASS'&&e.page.document_requests!==1){
    classification='PAGE_NAVIGATION_CHAIN_DRIFT';action_id='CONTRACT_REVIEW';reason_code='YANDEX_DOCUMENT_CHAIN_DRIFT';
...
export const CONTRACT_DRIFT_CLASSIFICATIONS=Object.freeze([
  'NO_DRIFT','CHALLENGE_SURFACE','AUTH_CONTRACT_DRIFT','PAGE_NAVIGATION_CHAIN_DRIFT','BROWSER_NAVIGATION_DRIFT',
